     ...
     <div class="row">
          ...
          <fieldset>
               ...
               <div class="col-lg-4 col-sm-4">
                    <label for="nip" class="control-label">Username</label>
               </div>
               <div class="col-lg-8 col-sm-8">
                    <input class="form-control" id="nip" name="nip" placeholder="Username" type="text" value="<?php echo set_value('txt_username'); ?>" />
